...
public class JdlRequisitosApp {

    private static final Logger log = LoggerFactory.getLogger(JdlRequisitosApp.class);

    private final Environment env;

    public JdlRequisitosApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes JDLRequisitos.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JdlRequisitosApp.class);
